...
# В планах
1) Добавить сохранение конфигурации клиента в файл(ip сервера, UDP порт, никнейм) - к защите на 3
2) Добавить регистрацию пользрвателей и БД SQL с данными пользователей - на 4
3) Добавить много поточность в main() на сервере - (опционально) на 4
4) Добавить UI (скорее всего на windowsAPI) - на 5
